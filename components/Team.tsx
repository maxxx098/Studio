      ...
      <div className="container mx-auto px-6 md:px-12">
         ...
         <div className="flex flex-col md:flex-row justify-between items-start mb-24 relative">
           ...
           >
             ...
             <div className="w-64 h-6 text-[#FFC247] mt-4">
           ...
           >
             ...
             <button className="mt-6 bg-[#FFC247] text-black px-8 py-3 rounded-full text-[10px] font-bold uppercase tracking-swiss-wide hover:scale-105 transition-transform">
                 View Team
             </button>
           </motion.div>
         </div>
         ...
         >
           {TEAM.map((member) => (
             ...
             >
                {/* The Card Frame */}
                <div className="border-2 border-[#FFC247] p-1 rounded-lg bg-[#0a0a0a] transition-transform duration-300 group-hover:-translate-y-2">
                    {/* Image Container */}
                    <div className="bg-neutral-800 overflow-hidden relative aspect-[4/3] rounded-t-md mb-1">
                        <img 
                            src={member.imageUrl} 
                            alt={member.name} 
                    ...
                    {/* Name Bar */}
                    <div className="bg-black py-4 px-4 flex justify-between items-end rounded-b-md">
                        <div>
                            <h3 className="text-lg uppercase tracking-swiss-tight text-white mb-1">{member.name}</h3>
                             {/* Mini Squiggle */}
                             <div className="w-12 h-2 text-[#FFC247]">
                                <svg viewBox="0 0 50 10" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M0 5 Q 5 0, 10 5 T 20 5 T 30 5 T 40 5" />
                                </svg>
                             </div>
                        </div>
                        <div className="w-8 h-8 bg-neutral-900 rounded flex items-center justify-center text-white border border-white/10 group-hover:bg-[#FFC247] group-hover:text-black transition-colors">
                            <LayoutGrid size={16} />
                        </div>
                    </div>
                </div>
         ...
         <div className="mt-32 pt-24 border-t border-white/10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
            ...
            <div className="lg:col-span-7 space-y-16">
                ...
                <motion.div
                    ...
                    className="pt-8"
                >
                   <span className="font-handwriting text-4xl text-white opacity-80" style={{ fontFamily: 'cursive' }}>Machell.</span>
                </motion.div>
            </div>
            ...
            <div className="lg:col-span-5 relative">
                 ...
                 >
                    ...
                    {/* Image Card */}
                    <div className="bg-[#FFC247] p-2 rounded-xl rotate-3 hover:rotate-0 transition-transform duration-500 shadow-2xl mt-12">
                        <div className="rounded-lg overflow-hidden relative">
                             <img src={ASSETS.HERO.MODEL_MAIN} alt="CEO" className="w-full h-auto object-cover aspect-[4/5] grayscale contrast-125" />
                             
                             {/* Sticker */}
                             <div className="absolute top-4 right-4 w-12 h-12 bg-[#FFC247] rounded-full flex items-center justify-center border-2 border-white shadow-lg z-30">
