...
const Testimonials: React.FC = () => {
  return (
    <section className="py-32">
      <div className="mx-auto px-15 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
             ...
             <div className="mt-4 w-12 h-12 bg-red-400 rounded-full flex items-center justify-center text-black">
               <Quote size={24} />
             </div>
          </motion.div>
            ...
            {TESTIMONIALS.map((t) => (
              ...
              >
                ...
                <div className="flex justify-between items-end">
                   <div>
                     <h4 className="font-bold text-red-400 uppercase tracking-widest text-sm">{t.author}</h4>
